...
namespace PaymentOptions.Migrations
{
    ...
    [Migration("20250615144405_add_lobcurrencymapping")]
    partial class add_lobcurrencymapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PaymentOptions.Model.LOBCurrencyMapping", b =>
                {
                    b.Property<int>("LOBCurrencyMappingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LOBCurrencyMappingId"));
                    ...
                    b.HasKey("LOBCurrencyMappingId");

                    b.ToTable("LOBCurrencyMappings");
                });
            ...
            modelBuilder.Entity("PaymentOptions.Model.MChannelDetail", b =>
                {
            ...
            modelBuilder.Entity("PaymentOptions.Model.PaymentTab", b =>
                {
                    ...
                    b.Property<string>("ChannelHashId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("EnableChannelHash")
                        .HasColumnType("bit");

                    b.Property<bool>("EnableLob")
                        .HasColumnType("bit");
